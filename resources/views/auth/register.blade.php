                     ...
                     <div class="row">
                        ...
                        @endif  
                           ...
                           <!-- Name -->
                              ...
                              <!-- Confirm Password -->
                              <div class="form-label-group">
                                 <input type="password" name="password_confirmation" id="inputPassC" class="form-control" placeholder="Confirm Password ">
                                 <label for="inputPassC">Confirm Password</label>
                              </div>
                              ...
                              <div class="text-center pt-3">
                                  have account? <a class="font-weight-bold" href="{{route('login')}}">Sign In</a>
                              </div>
                           </form>
                           <hr class="my-4">
